...
public class CrossSellConversion_Report_SMR {
    ...
    public void SMR() throws InterruptedException {
        this.driver = Cross_sell_Intrest_cost.driver;
        Thread.sleep(5000);
    }
    ...
    public void Zone_And_Region_Wise_Tab() throws InterruptedException {
        ...
        try {
            ...
            if (TotalInterestedValue <= 0 || z1 == null) {
                ...
                Assert.fail("No Data Found for Zone And Region Wise In CROSS sell conversion: " + z1);
            } else {
                // Print the Total Interested Leads value
                System.out.println("'Total Interested Leads' column Value of Zone And Region Wise Tab In CROSS sell conversion::: " + z1);
            }

        } catch (Exception e) {
            // Fail the test if an exception is thrown
            Assert.fail("No Data Found for Zone And Region Wise Tab In CROSS sell conversion " + e.getMessage());
        }
    }
    ...
    public void Dealer_Parent_Group_Wise_Tab() throws InterruptedException {
        ...
        try {
            ...
            if (TotalInterested <= 0 || d1 == null) {
                ...
                Assert.fail("No Data Found for Dealer Parent Group Wise  In CROSS sell conversion : " + d1);
            } else {
                // Print the Total Interested value
                System.out.println("'Total Interested Leads' column value of Dealer Parent Group Wise Tab In CROSS sell conversion::: " + d1);
            }

        } catch (Exception e) {
            // Fail the test if an exception is thrown
            Assert.fail("No Data Found for Dealer Parent Group Wise Tab In CROSS sell conversion " + e.getMessage());
        }
    }
    ...
    public void WorkShop_Wise_Tab() throws InterruptedException {
        ...
        try {
            ...
            if (TotalInterested <= 0 || w1 == null) {
                ...
                Assert.fail("No Data Found for WorkShop_Wise In CROSS sell conversion: " + w1);
            } else {
                // Print the Total Interested Leads value
                System.out.println("'Total Interested Leads' column value of WorkShop Wise Tab In CROSS sell conversion ::: " + w1);
            }

        } catch (Exception e) {
            // Fail the test if an exception is thrown
            Assert.fail("No Data Found for WorkShop Wise Tab In CROSS sell conversion " + e.getMessage());
        }
    }
    ...
    public void Day_Wise_Tab() throws InterruptedException {
        ...
        try {
            ...
            if (TotalInterested <= 0 || day1 == null) {
                // Fail the test if Total Interested Leads value is 0 or less
                Assert.fail("No Data Found for Day Wise Tab In CROSS sell conversion : " + day1);
            } else {
                // Print the Total Interested Leads value
                System.out.println("'Total Interested Leads' column value of Day Wise Tab In CROSS sell conversion ::: " + day1);
            }

        } catch (Exception e) {
            // Fail the test if an exception is thrown
            Assert.fail("No Data Found for Day Wise Tab In CROSS sell conversion " + e.getMessage());
        }
    }
    ...
    public void Service_Type_Wise_Tab() throws InterruptedException {
        ...
        try {
            ...
            if (TotalInterested <= 0 || s1 == null) {
                // Fail the test if Total Interested Leads value is 0 or less
                Assert.fail("No Data Found for Service Type Wise Tab In CROSS sell conversion: " + s1);
            } else {
                // Print the Total Interested Leads value
                System.out.println("'Total Interested Leads' column value of Service Type Wise Tab In CROSS sell conversion ::: " + s1);
            }

        } catch (Exception e) {
            // Fail the test if an exception is thrown
            Assert.fail("No Data Found for Service Type Wise Tab In CROSS sell conversion " + e.getMessage());
        }
    }
//..................................................................................................................			
